...
export default function Page() {
  ...
  const handleSubmit = () => {
    ...
    setTimeout(() => {
      ...
      if (isNegative) {
        setStep('shielded');
        // LOGIC: This is where we'll eventually send an email to Mike with:
        // Name: {name}, Phone: {phone}, Message: {feedback}
      } else {
        setStep('positive');
      }
    }, 1500);
      ...
      <div className="max-w-md w-full bg-zinc-900 border border-zinc-800 p-8 rounded-[2.5rem] shadow-2xl transition-all duration-500 min-h-[550px] flex flex-col justify-center">
        ...
        {step === 'input' && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="text-center mb-8">
              ...
              <p className="text-zinc-500 text-[9px] mt-2 font-bold tracking-[0.2em]">Customer Satisfaction Portal</p>
            </div>
        ...
        {step === 'shielded' && (
          <div className="text-center py-10 animate-in zoom-in duration-500">
            ...
            <p className="text-zinc-400 text-xs leading-relaxed mb-8 lowercase tracking-wide px-4">
              Thank you, {name.split(' ')[0]}. Mike has been notified and will call you at {phone} to make this right immediately.
            </p>
        ...
        {step === 'positive' && (
          <div className="text-center py-10 animate-in zoom-in duration-500">
            ...
            <p className="text-zinc-400 text-xs leading-relaxed mb-8 lowercase tracking-wide px-4">
              Thanks {name.split(' ')[0]}! Since you had a great experience, could you help Arctic Air by posting this to Google?
            </p>
            <button 
